...
public class Const {
	...
	public static final String SHOP_URL = "https://app4jbtmyne3011.h5.xiaoeknow.com";
	//Demo测试店铺的appID（三方 App 用户注册使用小鹅店铺，取得店铺appID  替换）
	public static final String APP_ID = "app4jbtmyne3011";
	//Demo测试店铺的sdkAppId（三方 App 用户购买小鹅店铺sdk获取sdkAppId 替换）
	public static final String CLIENT_ID = "nKQrkXPPScHw";
