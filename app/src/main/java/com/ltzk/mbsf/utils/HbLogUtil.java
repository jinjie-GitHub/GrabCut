...
/**
 * 描述：
 * 作者： on 2019/4/13 22:22
 * 邮箱：499629556@qq.com
 */
public class HbLogUtil {
    //单例
    private static HbLogUtil hbLogUtil;
    //Log 单词打印的最大长度
    private static final int MAX_LENGTH = 3 * 1024;

    static boolean IS_DEBUG = MainApplication.IS_DEBUG;
    //单例模式初始化
    public static HbLogUtil getInstance() {
        if (hbLogUtil == null) {
            hbLogUtil = new HbLogUtil();
        }
        return hbLogUtil;
    }
